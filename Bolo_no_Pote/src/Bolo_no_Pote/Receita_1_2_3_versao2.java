	...
	public static void main(String[] args) {
		...
		do {
			...
			if (escolha == 2) {
				...
				String[] Ingredientes_Receita_2 = { "Açucar", "Margarina", "Ovos", "Farinha de Trigo",
						"Leite Condensado", "creme de leite", "chocolate em pó" };
			...
			if (escolha == 3) {
				...
				String[] Ingredientes_Receita_3 = { "Açucar", "Margarina", "Ovos", "Farinha de Trigo",
						"Suco de maracujá", "Amido de Milho", "Leite", "Manteiga" };
			...
			System.out.println();
			System.out.print("Deseja continuar a pesquisa?\n");
